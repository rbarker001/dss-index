...
const QUERIES = [
  ...
  // ── START HERE ──────────────────────────────────────────────────────────
  {
    ...
    description: 'Count of facilities at each exposure level.',
    drilldown: {
  ...
  },
  {
    ...
    description: 'Exposure distribution and average staffing by state.',
    sql: `
  ...
  },
  {
    ...
    description: 'Every city ranked by % High + Moderate-High facilities.',
    drilldown: {
      paramCol: 'city',
  ...
  // ── FIND FACILITIES ─────────────────────────────────────────────────────
  {
    ...
    category: 'Find Facilities',
    title: 'High exposure facilities',
    description: 'All facilities rated High. Sorted by staffing (lowest first).',
    sql: `
  ...
  },
  {
    ...
    description: 'Combined shortlist — facilities warranting further review.',
    sql: `
  ...
  },
  {
    id: 'clean_facilities',
    category: 'Find Facilities',
    title: 'Zero Recognized conditions',
    description: 'Facilities with no conditions documented as Recognized in the CMS record.',
    sql: `
      SELECT f.name, a.exposure_level, a.overall_rating AS five_star,
  ...
  },
  {
    ...
    description: 'Highest regulatory risk facilities.',
    sql: `
  ...
  },
  {
    ...
    description: 'HPRD below 3.8 or RN hours below 0.75.',
    sql: `
  ...
  },
  {
    ...
    description: 'Staff churn above 60% — reduced capacity to detect neurological change.',
    sql: `
  ...
  },
  {
    ...
    category: 'Find Facilities',
    title: 'Below benchmark staffing + active High-risk conditions',
    description: 'Structural observational gap co-occurring with High recognition risk.',
    sql: `
  ...
  },
  {
    ...
    description: 'Exposure comparison between urban and rural facilities.',
    drilldown: {
      paramCol: 'urban_flag',
      title: '{value} — facilities',
      sql: `
  ...
  // ── DSS DOMAIN ANALYSIS ─────────────────────────────────────────────────
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Domain activity — all 4 domains with labels',
    description: 'Active conditions by DSS domain across all facilities. Click a row to drill into that domain.',
    drilldown: {
      paramCol: 'dss_domain',
  ...
  },
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Domain 1 — Seizure Events',
    description: 'Convulsive episodes, incontinence, post-ictal confusion, unexplained falls, nocturnal episodes.',
    sql: `
      SELECT f.name, c.condition_code, c.condition_name, c.classification,
  ...
  },
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Domain 2 — Movement Changes',
    description: 'Oral/limb/hand automatisms, episodic stiffness, seizure-precipitated falls.',
    sql: `
      SELECT f.name, c.condition_code, c.condition_name, c.classification,
             c.source_citation_value AS ftag, c.source_count AS citations, a.exposure_level,
             a.staffing_hprd, a.nursing_turnover_pct AS turnover
  ...
  },
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Domain 3 — Awareness Changes',
    description: 'Staring spells, unresponsiveness, acute confusion episodes, transient amnesia.',
    sql: `
      SELECT f.name, c.condition_code, c.condition_name, c.classification,
             c.source_citation_value AS ftag, c.source_count AS citations, a.exposure_level
      FROM condition c
  ...
  },
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Domain 4 — Behavioral Changes',
    description: 'Sudden agitation/fear, speech arrest, abrupt mood shifts, repetitive purposeless actions.',
    sql: `
      SELECT f.name, c.condition_code, c.condition_name, c.classification,
             c.source_citation_value AS ftag, c.source_count AS citations, a.exposure_level
      FROM condition c
  ...
  },
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Domains 3 + 4 — Awareness and Behavioral combined',
    description: 'The two domains most commonly mistaken for dementia progression.',
    sql: `
      SELECT f.name, c.condition_code, c.condition_name, c.classification,
  ...
  },
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Facilities with activity in 2+ domains',
    description: 'Multi-domain seizure presentation — the DSEF thesis indicator.',
    sql: `
      SELECT f.name, a.exposure_level,
  ...
  },
  {
    ...
    category: 'DSS Domain Analysis',
    title: 'Potential-to-Recognized ratio by domain',
    description: 'Which domains have the highest proportion of Potential (vs Recognized) classifications.',
    sql: `
      SELECT dss_domain,
             CASE dss_domain WHEN 1 THEN 'Seizure Events'
               WHEN 2 THEN 'Movement Changes'
  ...
  },
  {
    ...
    description: 'Full breakdown across all four DSS domains.',
    sql: `
      SELECT c.dss_domain,
             CASE c.dss_domain WHEN 1 THEN 'Seizure Events'
               WHEN 2 THEN 'Movement Changes'
  ...
  // ── CONDITION DEEP-DIVE ─────────────────────────────────────────────────
  {
    ...
    title: 'All conditions — Recognized / Potential / Not Identified',
    description: 'Classification totals for every condition across all facilities. Click a row to see which facilities carry that condition.',
    drilldown: {
  ...
  },
  {
    ...
    description: 'Every Recognized condition. What the CMS record has confirmed.',
    drilldown: {
      paramCol: 'condition_code',
  ...
  },
  {
    ...
    category: 'Condition Deep-Dive',
    title: 'F-tag citation totals',
    description: 'Total citations per F-tag. Click a row to see which facilities have that citation.',
    drilldown: {
      paramCol: 'ftag',
  ...
  },
  {
    ...
    category: 'Condition Deep-Dive',
    title: 'Potential-dominant conditions',
    description: 'Conditions where Potential outnumbers Recognized — likely under-documented seizure activity.',
    sql: `
  ...
  },
  {
    ...
    category: 'Condition Deep-Dive',
    title: 'High-risk condition count per facility',
    description: 'How many active High-risk conditions each facility carries.',
    sql: `
  ...
  },
  {
    ...
    description: 'Does a lower Five-Star rating correlate with higher DSS exposure?',
    sql: `
  ...
  // ── STAFFING & OWNERSHIP ────────────────────────────────────────────────
  {
    ...
    category: 'Staffing & Ownership',
    title: 'Exposure by ownership type',
    description: 'Do for-profit operators carry more DSS risk? Click a row to see facilities.',
    drilldown: {
  ...
  },
  {
    ...
    category: 'Staffing & Ownership',
    title: 'Reported vs PBJ staffing',
    description: 'Gap between self-reported and payroll-based staffing.',
    sql: `
      SELECT f.name, a.exposure_level,
  ...
  },
  {
    ...
    category: 'Staffing & Ownership',
    title: 'Over-reporters with F-658 citations',
    description: 'Facilities that over-report staffing AND have professional standards deficiencies.',
    sql: `
      SELECT f.name, a.exposure_level,
  ...
  },
  {
    ...
    description: 'Does lower staffing predict higher exposure?',
    drilldown: {
      paramCol: 'exposure_level',
  ...
  },
  {
    ...
    description: 'Average staffing hours per city. Are staffing gaps geographically concentrated?',
    drilldown: {
      paramCol: 'city',
      title: '{value} — staffing detail',
      sql: `
  ...
  // ── CITATION DETAIL ─────────────────────────────────────────────────────
  {
    ...
    title: 'Citation recency with stale flag',
    description: 'Every Recognized citation-based condition with dates and a stale flag (no citation in 24+ months).',
    sql: `
  ...
  },
  {
    id: 'severe_citations',
    category: 'Citation Detail',
    title: 'Severe citations (G+)',
    description: 'Citations at actual harm or immediate jeopardy severity.',
    sql: `
  ...
  },
  {
    id: 'survey_currency',
    category: 'Citation Detail',
    title: 'Survey currency',
    description: 'How fresh is each facility\'s citation record — latest citation date per facility.',
    sql: `
